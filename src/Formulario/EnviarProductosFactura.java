 ...
 * @author Miguel
 */
public class EnviarProductosFactura extends javax.swing.JInternalFrame {
    Sonidos SS = new Sonidos();
    DefaultTableModel tabla;
    

    /** Creates new form Productos */
    public EnviarProductosFactura() {
        initComponents();
     ...
     String comparar(String cod)
    {
        ...
        try {
            ...
            Logger.getLogger(EnviarProductosFactura.class.getName()).log(Level.SEVERE, null, ex);
        }
        return cant;   
    }
     void envio(){
