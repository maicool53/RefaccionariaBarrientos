...
public class EnviarClientesDeuda extends javax.swing.JInternalFrame {
    DefaultTableModel modelo;

    /** Creates new form clientes */
    public EnviarClientesDeuda() {
        initComponents();
        mostrarclientes("");
    ...
    private void mostrarclientes(String valor){
        ...
        try {
            ...
            Logger.getLogger(EnviarClientesDeuda.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    try {
        ...
        else
        {
         ...
         IngresoDeudas.txtnomape.setDisabledTextColor(Color.blue);
         IngresoDeudas.txtnomape.setText(nom+" "+ape);
         this.dispose();
